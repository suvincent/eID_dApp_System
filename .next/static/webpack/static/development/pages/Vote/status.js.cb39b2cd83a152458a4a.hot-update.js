          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 22:
                ...
                for (item in time) {
                  correct_time.push(new Date(item).toString);
                }
